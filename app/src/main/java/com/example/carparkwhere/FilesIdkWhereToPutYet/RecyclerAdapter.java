...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public RecyclerAdapter(List<BookmarkedCarparks> bookmarkedCarparks) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.bookmarked_carparks, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        BookmarkedCarparks bookmarks = bookmarkedCarparks.get(position);
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            textView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    BookmarkedCarparks bookmark = bookmarkedCarparks.get(getAdapterPosition());
